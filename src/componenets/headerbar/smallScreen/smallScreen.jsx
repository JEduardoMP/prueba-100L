      ...
      <div className="flex absolute w-full justify-center items-center">
        ...
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M2 6.25C2 5.56 2.56 5 3.25 5h17.5a1.25 1.25 0 1 1 0 2.5H3.25C2.56 7.5 2 6.94 2 6.25zm0 6c0-.69.56-1.25 1.25-1.25h17.5a1.25 1.25 0 1 1 0 2.5H3.25c-.69 0-1.25-.56-1.25-1.25zM3.25 17a1.25 1.25 0 1 0 0 2.5h17.5a1.25 1.25 0 1 0 0-2.5H3.25z"
            fill="#fff"
          />
        </svg>
